...
export class ClosedTripsComponent implements OnInit {
  ...
  constructor(private driverApiService: DriverApiService, private router: Router, private activatedRoute: ActivatedRoute, private tripDetailsApiService: TripDetailsApiService) { }
