...
export class VehicleauthdriversComponent implements OnInit {
  ...
  driversList = [];
  constructor(public activeModal: NgbActiveModal, private calendar: NgbCalendar, private driverDutyApiService: DriverDutyApiService, private ngbDateFRParserFormatter: NgbDateFRParserFormatter, 
