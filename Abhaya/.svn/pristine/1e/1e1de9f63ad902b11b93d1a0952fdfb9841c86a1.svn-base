...
export class MovementdetailsComponent implements OnInit {
  ...
  getCommunicationDetails(page, searchvalue) {
    this.formatDate = this.ngbDateFRParserFormatter.format(this.model);
    this.deviceCommunicationApi.getCommunicationDetails(page, 10, this.statusModel, this.movementModel, this.userDetails.stateId, this.districtModel, this.cityModel, searchvalue, this.formatDate)
