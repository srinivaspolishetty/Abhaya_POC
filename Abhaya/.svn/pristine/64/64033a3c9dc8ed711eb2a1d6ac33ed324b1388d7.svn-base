...
@NgModule({
  ...
  declarations: [FooterComponent, VehiclesComponent, DriversComponent, DriverDutyComponent,
    ...
    VehiclemapComponent, DriverdetailsComponent, DriverdetailsviewComponent, RoutedeviationviewComponent, VehicleauthdriversComponent, DevicecommunitationComponent, MovementdetailsComponent, TripandroutedeviationComponent, MovementdetailsreportComponent, MovementgraphreportComponent, VehicleAuthreportComponent, PanicdetailsreportComponent, DistrictwisetrackingreportComponent, DevicecommunicatingreportComponent],
