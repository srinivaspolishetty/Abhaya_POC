...
export class DriverdetailsviewComponent implements OnInit {
  ...
  noAuthData = false;
  model: NgbDateStruct;
  constructor(public activeModal: NgbActiveModal, private driverDutyApiService: DriverDutyApiService, private calendar: NgbCalendar, private ngbDateFRParserFormatter: NgbDateFRParserFormatter) {
